...
public partial class showUDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string strQuery = "SELECT [Time_Of_Registration], [Name], [Date_of_Birth], [Email_Address], [Mobile_Number] FROM [register]";
